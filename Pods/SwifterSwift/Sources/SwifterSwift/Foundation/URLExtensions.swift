...
public extension URL {
    ...
    var queryParameters: [String: String]? {
        ...
        for queryItem in queryItems {
            products[queryItem.name] = queryItem.value
        }
...
public extension URL {
    ...
    func appendingQueryParameters(_ parameters: [String: String]) -> URL {
        ...
        var products = urlComponents.queryItems ?? []
        products += parameters.map({ URLQueryItem(name: $0, value: $1) })
        urlComponents.queryItems = products
